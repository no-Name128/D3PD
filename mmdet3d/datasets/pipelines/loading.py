...
class PrepareImageInputs(object):
    ...
    def __init__(
        ...
        self.ret_l2c = ret_l2c

    def get_l2c(self, sensor2lidar_rotation, sensor2lidar_translation, cam_intrinsic):
        ...
        lidar2img_rt = torch.tensor(lidar2img_rt)
            ...
            for adj_info in results["adjacent"]:
                ...
                for cam_name in cam_names:
                    ...
                    if self.ret_l2c:
                        lidar2img.append(
                            self.get_l2c(
                                adj_info["cams"][cam_name]["sensor2lidar_rotation"],
                                adj_info["cams"][cam_name]["sensor2lidar_translation"],
                                adj_info["cams"][cam_name]["cam_intrinsic"],
                            )
                        )
    ...
    def __call__(self, results):
        if self.ret_l2c:
            ...
            results["img_inputs"] = img_inputs[:-1]
            results['lidar2img']=img_inputs[-1]
        else:
