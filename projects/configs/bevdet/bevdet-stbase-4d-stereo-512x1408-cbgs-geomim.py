...
model = dict(
    ...
    img_backbone=dict(
        ...
        embed_dims=128,
        init_cfg=dict(
            checkpoint="/mnt/data/exps/ckpt/geomim_base.pth", type="Pretrained"
        ),
        num_heads=[4, 8, 16, 32],
        out_indices=[2, 3],
        patch_norm=True,
...
#     backend="petrel",
#     conf_path="/mnt/lustre/liujihao/petreloss_openmmlab.conf",
#     path_mapping=dict(
#         {
...
train_pipeline = [
    ...
    dict(
        type="LoadAnnotationsBEVDepth", bda_aug_conf=bda_aug_conf, classes=class_names
    ),
    dict(
...
test_data_config = dict(
    ...
    ann_file=data_root + "bevdetv3-new_gtboxes-nuscenes_infos_val.pkl",
)
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            data_root=data_root,
            ann_file=data_root + "bevdetv3-new_gtboxes-nuscenes_infos_train.pkl",
