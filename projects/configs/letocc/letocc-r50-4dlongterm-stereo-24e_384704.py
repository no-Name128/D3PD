...
model = dict(
    ...
    img_view_transformer=dict(
        ...
        depthnet_cfg=dict(
            use_dcn=False, with_cp=True, aspp_mid_channels=96, stereo=True, bias=5.0
        ),
        downsample=16,
    ),
    # fast voxel gen
    fast_voxel_gen=dict(
        type="FastVoxelGen", multi_frame_range=len(range(*multi_adj_frame_id_cfg))
    ),
...
load_from = "/mnt/data/exps/ckpt/bevdet-occ-r50-4d-stereo-24e.pth"
